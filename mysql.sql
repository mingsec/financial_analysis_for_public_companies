-- Create database
CREATE DATABASE financial_analysis_for_public_companies;
...
CREATE TABLE issue_information(
  ...
  每股发行价_元  decimal(5,2)  NOT NULL, 
  发行方式    char(255)  NOT NULL,
  发行市盈率_按发行后总股本  decimal(10,2)  NOT NULL, 
  首发前总股本_万股  decimal(18,2)  NOT NULL,
  首发后总股本_万股  decimal(18,2)  NOT NULL,
  实际发行量_万股  decimal(18,2)  NOT NULL,
  预计募集资金_万元  decimal(18,2)  NOT NULL,
  实际募集资金合计_万元  decimal(18,2)  NOT NULL,
  发行费用总额_万元  decimal(18,2)  NOT NULL,
  募集资金净额_万元  decimal(18,2)  NOT NULL,
  承销费用_万元  decimal(18,2)  NOT NULL,
  招股公告日  date  NOT NULL,
  上市日期  date  NOT NULL,
  PRIMARY KEY (公司代码)
)ENGINE=InnoDB;